...
function SectionBtn({ content }: { content: string }) {
  return (
    <button className="px-4 py-2 text-gray-300 rounded-full flex items-center space-x-2 overflow-hidden bg-transparent border-white border-[1px] border-opacity-100 bg-opacity-95 mx-auto">
