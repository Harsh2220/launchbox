...
function SectionBtn({ content }: { content: string }) {
  return (
    <button className="mt-40 px-4 py-2 text-gray-300 rounded-full flex items-center space-x-2 overflow-hidden bg-[#222320] border-white border-[0.1px] border-opacity-20 bg-opacity-95 mx-auto">
